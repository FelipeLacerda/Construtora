 ...
 */
public class VendasAll extends javax.swing.JDialog {
     ...
     */
    public VendasAll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jbeditcliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbeditcliActionPerformed
        ...
        try {
            ...
            Logger.getLogger(VendasAll.class.getName()).log(Level.SEVERE, null, ex);
        }
            ...
            if (contratos == null) {
                ...
                for (Contrato c : contratos) {
                    modeloTableDados.addRow(new Object[]{
                        c.getIdContrato(), c.isCertificacaoCli(),
                        c.isCertificacaoAdm(), c.isCertificacaoImo()
                    });
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendasAll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VendasAll dialog = new VendasAll(new javax.swing.JFrame(), true);
