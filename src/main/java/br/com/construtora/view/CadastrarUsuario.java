...
public class CadastrarUsuario extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(415, 480));
        setMinimumSize(new java.awt.Dimension(415, 480));
        setModal(true);
        setPreferredSize(new java.awt.Dimension(425, 515));
        getContentPane().setLayout(null);

        jToggleButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/adc2.png"))); // NOI18N
        getContentPane().add(jToggleButton1);
        jToggleButton1.setBounds(150, 50, 110, 110);

        jLabel1.setText("Login: ");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(80, 190, 90, 14);
        getContentPane().add(tflogin);
        tflogin.setBounds(130, 180, 150, 30);

        jLabel2.setText("Senha: ");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(70, 230, 90, 14);
        getContentPane().add(tfsenha);
        tfsenha.setBounds(130, 220, 150, 30);

        jLabel3.setText("Confirmar senha: ");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(20, 270, 130, 14);
        getContentPane().add(tfconfirmar);
        tfconfirmar.setBounds(130, 260, 150, 30);
        ...
        jButton1.setBounds(60, 410, 140, 40);
        ...
        jButton2.setBounds(200, 410, 140, 40);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("CADASTRAR USUÁRIO");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(130, 10, 240, 17);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/cadmenor.jpg"))); // NOI18N
        getContentPane().add(jLabel5);
        jLabel5.setBounds(0, 0, 410, 480);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (senha1.equals(senha2)) {
            ...
            JOptionPane.showMessageDialog(null, MensagemUtilUsuario.getValor(MensagemUtilUsuario.MSG_ERRO_SALVARUSU), MensagemUtilUsuario.getValor(MensagemUtilUsuario.CABE_ERRO), JOptionPane.ERROR_MESSAGE);
        }
